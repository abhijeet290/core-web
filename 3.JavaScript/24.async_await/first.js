...
// if we write these two promises p1 and p2 outside the function, in that case it will run parallelly

// in case we wrap p1 and p2 inside a function called test1 and test2 in that case it will execute the first functiion and wait for it till resolve then it will go to resolve the second function
